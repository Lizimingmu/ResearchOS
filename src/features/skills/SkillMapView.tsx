...
export function SkillMapView() {
  const states = useAppStore((state) => state.learnerUnitStates), events = useAppStore((state) => state.learningEvents), artifacts = useAppStore((state) => state.transferArtifacts), contentProgress = useAppStore((state) => Object.values(state.learningContentProgress)), legacyEvidence = useAppStore((state) => state.skillEvidence);
