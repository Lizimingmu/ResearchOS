...
"staged-concept-selection-bias-apply":{actionLabelOverrides:{decision:"识别肿瘤体积同时影响组织可用性，并与标志物及复发相关，因此进入组织子样本可能扭曲关联"},adjudicationCn:"删除原先超出材料的‘暴露与结局共同导致选择’因果措辞。"},
"staged-concept-effect-size-remediation":{taskContract:"classification",promptCn:"选择最能概括当前效应尺度与实施意义的一项判断；集群相关结构作为随后精度核查。",adjudicationCn:"原题同时含效应尺度和集群精度两个首要问题；限定本题构念为 Effect Size。"},
...
"staged-concept-censoring-apply":{taskContract:"multi_select_audit",requiredActionKeys:["decision","key_check","boundary"],adjudicationCn:"原 ordering 混合动作与边界，缺少唯一科学顺序。"},
...
"staged-method-restricted-cubic-spline-review":{actionLabelOverrides:{decision:"仅确认 4.2–6.1 范围内的运输性；现有验证不能支持 7.0 mmol/L 后的陡升形状"},promptCn:"选择同时写清已验证范围与未验证高端曲线的完整结论。",adjudicationCn:"合并原 O1/O3 两个各自正确但不完整的结论。"},
...
export const m0191cFlaggedLogicalIds=new Set([
  "staged-concept-ai-cognitive-outsourcing-remediation",
  "staged-concept-association-causation-apply",
  "staged-concept-association-causation-remediation",
  "staged-concept-association-causation-review",
