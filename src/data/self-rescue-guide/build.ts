...
function sourceIdsFor(module: GuideModuleSpec, topic: GuideTopicSeed): string[] {
  ...
  const specific: Array<[RegExp, string[]]> = [
    ...
    [/prediction|external validation|validation set/i, ["src-tripod", "src-pm-external"]],
    [/unit|replicate|pseudorep/i, ["src-pseudorep"]],
    [/confound|caus|collider|mediat/i, ["src-dag"]],
    [/PCA/i, ["src-pca"]],
    [/UMAP/i, ["src-umap"]],
    [/NMF/i, ["src-nmf"]],
    [/GSEA|enrichment/i, ["src-gsea"]],
    ...
    [/multi-omics|cross-modal|concordance|discordance/i, ["src-multiomics"]],
    [/AI|cognitive outsourcing|hallucination|prompt/i, ["src-nist-ai-rmf"]],
