...
The initial JavaScript is 868,012 bytes (171,662 bytes gzip), down 70.3% from the audited v0.9 baseline of 2,925,687 bytes. Paper Lab and PDF.js remain lazy feature payloads rather than startup work.

| Status | Metric | Observed | Budget |
|---|---|---:|---:|
| PASS | Initial JavaScript | 868,012 bytes | < 1,900,000 bytes |
| PASS | Initial CSS | 65,119 bytes | < 70,000 bytes |
| PASS | Training content chunk | 81,995 bytes | < 150,000 bytes |
| PASS | Scheduler mean | 0.0769 ms | < 2 ms |
...
- Today scheduling averaged 0.0769 ms over 2,000 deterministic runs.
