...
- Current gate: `PATCH REQUIRED`; M013-11R passes, with one metadata-only correction remaining for `pa-src-altman-validation` PMID (`19477892`); see `.agent/REVIEW_RESULT.md`
- Current milestone: OpenCode M013-11R2 metadata correction, then Codex final release gate; the 166 external cards remain quarantined for a later corpus milestone
