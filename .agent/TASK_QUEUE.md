...
| M016-LK-01 | P0 | Implement Learning Kernel domain/schema and two-axis skill projection | OpenCode Pro + Codex rescue | COMPLETED: versioned units/states/events/prerequisites/bindings; cross-object validators; instruction and competence remain separate | Architecture Yes |
| M016-LK-02 | P0 | Add backward-compatible state schema 4→5 migration | OpenCode Pro + Codex rescue | COMPLETED: old data preserved; new state empty; no inferred mastery; reopen/future-schema gates pass | No |
