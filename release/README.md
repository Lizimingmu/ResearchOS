...
`RELEASE_NOTES_v0.12.0.md`. Earlier artifacts (v0.9.0–v0.11.0) are retained for rollback and were not overwritten.
v0.10.0 is retained for audit but is superseded due to its blank-screen browser-bundle defect and should not be distributed.
